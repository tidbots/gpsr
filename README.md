...
gpsr_command_parser_node（hsr_gpsr_nlp 内）
...
gpsr_smach_node（hsr_gpsr_smach 内）
...
hsr_nav_client_node（hsr_nav_wrapper 内）
...
hsr_task_executor_node（hsr_task_executor 内）
