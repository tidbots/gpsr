...
awarded only when all three commands are received at once. The interleaved execution
RoboCup@Home Rulebook / Final version for RoboCup 2026 (Revision 2025-12-01 1)
44 5.3 General Purpose Service Robot
must be meaningful, for example by saving time or reducing unnecessary movements. Example:
...
1https://github.com/RoboCupAtHome/CommandGenerator
RoboCup@Home Rulebook / Final version for RoboCup 2026 (Revision 2025-12-01 1)
Chapter 5. Tests 45
Action Score
Main Goal
